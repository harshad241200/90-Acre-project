...
namespace dashboardscrud.Content
{
    public partial class edit : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select * from Addproperty14  where id='" + id + "'";
